...
def sequence(seqNo): #to call each frame in a given sequence
    ...
    if seqNo<10:
        ...
        n=str(seqNo)
    location='C:/Users/akhil/Desktop/UROP/datasets/fall-'+n+'-cam0-rgb'
    ...
    for i in range(1,framecount+1):
        if i<100:
            ...
            x=str(i)
        print(seqNo,x)
        frameLocation='C:/Users/akhil/Desktop/UROP/datasets/fall-'+n+'-cam0-rgb/fall-'+n+'-cam0-rgb-'+str(x)+'.png'
        frameData=frame(frameLocation)
        if frameData==None:
            continue
        seqData=seqData+frameData
